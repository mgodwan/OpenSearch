...
public class CompositeIndexingExecutionEngineTests extends OpenSearchTestCase {
    ...
    public void testConstructorThrowsWhenPrimaryFormatNotRegistered() {
        ...
        IllegalArgumentException ex = expectThrows(
            ...
            () -> new CompositeIndexingExecutionEngine(indexSettings, null, new CompositeTestHelper.StubCommitter(), registry, null)
        );
    ...
    public void testConstructorRejectsNullDataFormatRegistry() {
        ...
        expectThrows(
            ...
            () -> new CompositeIndexingExecutionEngine(indexSettings, null, new CompositeTestHelper.StubCommitter(), null, null)
        );
    }
    ...
    public void testConstructorRejectsNullIndexSettings() {
        ...
        expectThrows(
            NullPointerException.class,
            () -> new CompositeIndexingExecutionEngine(null, null, new CompositeTestHelper.StubCommitter(), registry, null)
        );
    }
    ...
    public void testConstructorThrowsWhenCommitterNull() {
        ...
        IllegalStateException ex = expectThrows(
            IllegalStateException.class,
            () -> new CompositeIndexingExecutionEngine(indexSettings, null, null, registry, null)
        );
    ...
    public void testRefreshNeverCallsCommitterMethods() throws IOException {
        ...
        CompositeIndexingExecutionEngine engine = new CompositeIndexingExecutionEngine(indexSettings, null, tracking, registry, null);
    ...
    public void testInitCalledDuringConstruction() {
        ...
        CompositeIndexingExecutionEngine engine = new CompositeIndexingExecutionEngine(indexSettings, null, stub, registry, null);
        assertNotNull(engine);
    }

    public void testCloseFailureIsLoggedAndShutdownContinues() throws IOException {
        ...
        CompositeIndexingExecutionEngine engine = new CompositeIndexingExecutionEngine(indexSettings, null, failingClose, registry, null);
