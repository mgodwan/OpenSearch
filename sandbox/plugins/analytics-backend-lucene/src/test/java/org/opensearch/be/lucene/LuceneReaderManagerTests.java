...
public class LuceneReaderManagerTests extends OpenSearchTestCase {
    ...
    public void testCreateReaderManagerWithLuceneIndexingEngine() throws IOException {
        ...
        CommitterConfig cs = new CommitterConfig(
            createEngineConfig(store, idxSettings, shardId)
        );
    ...
    private EngineConfig createEngineConfig(Store store, IndexSettings indexSettings, ShardId shardId) {
        ...
        org.mockito.Mockito.when(mockPluginsService.filterPlugins(EnginePlugin.class))
            .thenReturn(java.util.List.of(new LucenePlugin()));
