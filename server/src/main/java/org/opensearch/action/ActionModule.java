...
import org.opensearch.action.admin.indices.template.contextaware.TransportPutContextTemplateAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(PutContextTemplateAction.INSTANCE, TransportPutContextTemplateAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestContextTemplateAction());
