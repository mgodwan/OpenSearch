...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    private final String transportActionForParsedDocRep;
    ...
    public TransportShardBulkAction(
        ...
        this.transportActionForParsedDocRep = ACTION_NAME + "[parsed_doc_rep]";
    ...
    private final class ParseAwareReplicationProxy extends WriteActionReplicasProxy {
    ...
    public static Translog.Location performOnReplica(BulkShardRequest request, IndexShard replica) throws Exception {
        ...
        for (int i = 0; i < request.items().length; i++) {
            ...
            if (item.getPrimaryResponse().isFailed()) {
                ...
                operationResult = performOpOnReplica(response.getResponse(), item.request(), request.parsedEntities[i], replica);
            }
