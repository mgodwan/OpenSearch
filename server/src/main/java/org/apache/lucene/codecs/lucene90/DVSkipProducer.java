...
import static org.apache.lucene.codecs.lucene90.DVSkipConsumer.SKIP_INDEX_JUMP_LENGTH_PER_LEVEL;
import static org.apache.lucene.codecs.lucene90.DVSkipConsumer.SKIP_INDEX_MAX_LEVEL;
...
public final class DVSkipProducer extends DocValuesProducer {
    ...
    DVSkipProducer(SegmentReadState state, String dataCodec, String dataExtension, String metaCodec, String metaExtension)
        throws IOException {
    ...
    public DocValuesProducer getMergeInstance() {
        return new DVSkipProducer(numerics, binaries, sorted, sortedSets, sortedNumerics, skippers, data, maxDoc, version, true);
    }
    ...
    private static class DocValuesSkipperEntry {
        long offset;
        long length;
        long minValue;
        long maxValue;
    ...
    public SortedSetDocValues getSortedSet(FieldInfo field) throws IOException {
        ...
        if (ordsEntry.blockShift < 0 && ordsEntry.bitsPerValue > 0) {
            ...
            final RandomAccessInput addressesInput = data.randomAccessSlice(ordsEntry.addressesOffset, ordsEntry.addressesLength);
